...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "8310151703:AAF5bZArqvaABPANi3TtqqEWpvYhhTtL5nE")
...
DB_NAME = os.environ.get("DATABASE_NAME", "moon_files")

TG_BOT_WORKERS = int(os.environ.get("", ""))
